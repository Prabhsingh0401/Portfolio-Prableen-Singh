...
const Footer = () => {
    return (
        ...
        <div className="absolute inset-0 flex items-center justify-center overflow-hidden pointer-events-none">
            <h2 className="text-[12vw] md:text-[10vw] font-bold text-white/[0.03] whitespace-nowrap select-none" style={{ textShadow: '0 0 80px rgba(255,255,255,0.15)' }}>
                Prableen Singh
            </h2>
        </div>
        <footer className="w-full bg-[#121212]/80 backdrop-blur-md border-t border-white/10 mt-20 py-8 relative z-10">
            ...
            <div className="flex items-center gap-3">
                ...
                <span className="text-sm text-gray-400 sm:text-center">© 2026 <a href="#Home" className="hover:text-[#f28e63] transition-colors duration-300">Prableen Singh</a>. All Rights Reserved.
                </span>
            </div>
